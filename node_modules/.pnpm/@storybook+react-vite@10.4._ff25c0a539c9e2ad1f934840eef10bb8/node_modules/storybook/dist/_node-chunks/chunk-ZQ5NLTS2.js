...
import {
  require_build
} from "./chunk-OCHY2TY6.js";
import {
  STORYBOOK_FN_PLACEHOLDER,
  generateDummyArgsFromArgTypes,
  loadConfig,
  printConfig
} from "./chunk-SA3UWYRW.js";
import {
  StorybookError
} from "./chunk-SJTHLB7E.js";
import {
  isI18nPackage,
  isRouterPackage,
  isStateManagementPackage,
  isStylingPackage
} from "./chunk-HM6QFLRG.js";
import {
...
var getComponentVariableName = async (name) => (await import("./camelcase-EGNQ2JHN.js")).default(name.replace(/^[^a-zA-Z_$]*/, ""), { pascalCase: !0 }).replace(/[^a-zA-Z_$]+/, "");
