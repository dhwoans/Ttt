...
import {
  ...
  toPath,
  traversePathUp
} from "./chunk-DDXC5KYD.js";
import {
  versions_default
} from "./chunk-DUA3THVM.js";
import {
  logger
} from "./chunk-6GLEZUPS.js";
import {
  BUN_LOCKFILE,
  BUN_LOCKFILE_BINARY,
  NPM_LOCKFILE,
...
import {
  ...
  up,
  up2
} from "./chunk-Y5XIETER.js";
import {
  importModule,
  resolveModulePath,
  resolvePackageDir,
  safeResolveModule
} from "./chunk-SOCOANKH.js";
import {
  join,
  parse,
  resolve
} from "./chunk-44YWME5V.js";
import {
  require_dist
} from "./chunk-C4KI5RNF.js";
import {
  require_picocolors
} from "./chunk-NP3B2HKL.js";
import {
  slash
} from "./chunk-VWS27CF2.js";
import {
  glob,
  globSync
} from "./chunk-W6G6WTNU.js";
import {
  __commonJS,
  __esm,
  __export,
...
async function scanAndTransformFiles({
  ...
  let globby = (await import("./globby-VANCOAKK.js")).globby, sourceFiles = await globby([glob2], {
    ...commonGlobOptions(""),
    ignore: ["**/node_modules/**"],
    dot: !0,
    cwd: getProjectRoot(),
...
var transformImportFiles = async (files, renamedImports, dryRun) => {
  let errors = [], { default: pLimit } = await import("./p-limit-EKBALEI3.js"), limit = pLimit(10);
  return await Promise.all(
    files.map(
      (file) => limit(async () => {
        try {
