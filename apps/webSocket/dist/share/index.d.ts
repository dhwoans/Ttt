...
type ClientSchemas = import("./socket-client-events.types.js").components["schemas"];
type ServerSchemas = import("./socket-server-events.types.js").components["schemas"];
...
export type ServerEvents = {
    ...
    READY_TIMEOUT_STARTED: (payload: ServerSchemas["ReadyTimeoutStartedEvent"]) => void;
    READY_TIMEOUT_EXPIRED: (payload: ServerSchemas["ReadyTimeoutExpiredEvent"]) => void;
    READY_TIMEOUT_CANCELED: (payload: ServerSchemas["ReadyTimeoutCanceledEvent"]) => void;
    PLAYING: (payload: ServerSchemas["PlayingEvent"]) => void;
    TURN_TIMEOUT_STARTED: (payload: ServerSchemas["TurnTimeoutStartedEvent"]) => void;
